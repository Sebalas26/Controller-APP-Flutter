...
// Added in 1.78b for Result's checking
...
- (long) checkStatus;    //by seok 19.10.11
- (void) recvBTConnection;  //by seok 19.10.11
- (void) getVersion;    //by seok 19.10.25

// Wi-Fi only.
- (long) getPrinterInfo:(unsigned char *)SendBuf charsToSend:(int)wLength withRecvBuf:(unsigned char *)RecvBuf;
- (long) resetPrinter;
// Added in 1.81b to set printer's info.
